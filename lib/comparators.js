...
const QUERY_COMPARATORS = pick_1.default(ALL_COMPARATORS, [
    'EQ',
    'LT',
    'LTE',
    'GT',
...
const getComparators = ({ queryInfo, property }) => {
...
function forEachLeaf(obj, fn) {
    traverse_1.default(obj).forEach(function (value) {
        if (this.isLeaf) {
