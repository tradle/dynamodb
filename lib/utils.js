...
const getTableDefinitionForModel = ({ models, model }) => {
    ...
    return Object.assign({}, primaryKeys, { tableName: getTableName({ model }), timestamps: true, createdAt: false, updatedAt: '_dateModified', schema: toJoi({ models, model }), indexes: model.primaryKeys ? [] : constants_2.defaultIndexes, validation: {
            allowUnknown: true
        } });
};
const getDefaultTableDefinition = ({ tableName }) => {
    return Object.assign({}, constants_2.defaultPrimaryKeys, { tableName, timestamps: true, createdAt: false, updatedAt: '_dateModified', schema: metadataTypes, indexes: constants_2.defaultIndexes, validation: {
            allowUnknown: true
        } });
};
