...
exports.getPreferredQueryProperty = ({ table, hashKeyProps, filter }) => {
    const { indexed } = table;
...
exports.getQueryInfo = ({ table, filter, orderBy, type }) => {
    ...
    if (opType === 'query') {
        ...
        const preferred = exports.getPreferredQueryProperty({ table, hashKeyProps: usedHashKeyProps, filter });
