...
exports.normalizeIndexedPropertyTemplateSchema = (property) => {
    if (typeof property === 'string' || Array.isArray(property)) {
        return {
            hashKey: exports.getKeyTemplateFromProperty([].concat(property).join('.'))
        };
    }
    ...
    return {
        hashKey: typeof hashKey === 'string' ? exports.getKeyTemplateFromProperty(hashKey) : hashKey,
        rangeKey: typeof rangeKey === 'string' ? exports.getKeyTemplateFromProperty(rangeKey) : rangeKey,
    };
};
exports.getKeyTemplateFromProperty = (property) => ({ template: `{{${property}}}` });
...
// })
exports.getExpandedProperties = ({ models, model }) => (Object.assign({}, model.properties, OriginalBaseObjectModel.properties, getNestedProperties({ models, model })));
