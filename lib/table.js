...
class Table extends events_1.EventEmitter {
    constructor(opts) {
        ...
        const { models, model, modelsStored = {}, objects, exclusive, allowScan, readOnly, defaultReadOptions, tableDefinition, deriveProperties = lodash_1.default.stubObject, derivedProperties = [], resolveOrderBy = defaults.resolveOrderBy, getIndexesForModel = defaults.getIndexesForModel, getPrimaryKeysForModel = defaults.getPrimaryKeysForModel, shouldMinify = lodash_1.default.stubTrue } = this.opts;
        if (!models)
