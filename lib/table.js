...
class Table extends events_1.EventEmitter {
    constructor(opts) {
        ...
        this.getKeyTemplatesForModel = (model) => {
            ...
            return raw.slice(0, this.indexed.length).map((indexedProp, i) => (Object.assign(Object.assign({}, indexedProp), { hashKey: Object.assign(Object.assign({}, indexedProp.hashKey), { key: this.indexed[i].hashKey }), rangeKey: indexedProp.rangeKey && Object.assign(Object.assign({}, indexedProp.rangeKey), { key: this.indexed[i].rangeKey }) })));
        };
        ...
        this.get = async (query, opts = {}) => {
            ...
            if (this._hasAllPrimaryKeys(keysObj)) {
                ...
                result = await this.table.get(...keys, Object.assign(Object.assign({}, this.opts.defaultReadOptions), opts));
            }
            else {
        ...
        this.find = async (_opts) => {
            const opts = Object.assign(Object.assign(Object.assign({}, this.findOpts), lodash_1.default.cloneDeep(_opts)), { table: this });
        ...
        this.findOne = async (opts) => {
            opts = Object.assign(Object.assign({}, opts), { limit: 1 });
        ...
        this._write = async (method, resource, options = {}) => {
            ...
            if (method === 'create') {
                ...
                const { diff } = options;
                validateDiff(diff);
                options = Object.assign(Object.assign({}, utils.createUpdateOptionsFromDiff(diff)), lodash_1.default.omit(options, ['diff']));
