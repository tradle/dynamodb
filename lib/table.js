...
class Table extends events_1.EventEmitter {
    constructor(opts) {
        ...
        this.latest = (query, opts = {}) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        this._exportResource = resource => _.omit(resource, constants_2.typeAndPermalinkProperty);
        ...
        this.find = (opts) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            opts = Object.assign({}, this.findOpts, _.cloneDeep(opts), { table: this });
        ...
        this.prefixPropertyNamesForType = function (type, props) {
            return this.exclusive ? props : props.map(prop => prefix_1.prefixString(prop, this.getPrefix(type)));
        };
        this._write = (method, resource, options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let result;
            try {
                result = yield this.table[method](formatted, options);
            }
            catch (err) {
