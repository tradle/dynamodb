...
class Table extends events_1.EventEmitter {
    constructor(opts) {
        ...
        this.deriveProperties = resource => {
            return lodash_1.default.omitBy(this._deriveProperties(resource), prop => prop in resource);
        };
        ...
        // }
        this.addDerivedProperties = resource => lodash_1.default.extend(resource, this.deriveProperties(resource));
        ...
        this.resolveOrderBy = (hashKey, property) => {
