...
class Table extends events_1.EventEmitter {
    constructor(opts) {
        ...
        this._exportResource = resource => this.omitDerivedProperties(utils_1.resultsToJson(resource));
        ...
        const { models, model, modelsStored = {}, objects, exclusive, allowScan, readOnly, defaultReadOptions, tableDefinition, deriveProps = lodash_1.default.stubObject, derivedProps = [], resolveOrderBy = defaults.resolveOrderBy, getIndexesForModel = defaults.getIndexesForModel, getPrimaryKeysForModel = defaults.getPrimaryKeysForModel, parseDerivedProps = lodash_1.default.stubObject, shouldMinify = lodash_1.default.stubTrue } = this.opts;
        if (!models)
        ...
        // @ts-ignore
        this.tableDefinition = tableDefinition.TableName ? utils_1.toDynogelTableDefinition(tableDefinition) : tableDefinition;
        ...
        this.model = model;
        this._prefix = {};
        this.primaryKeys = utils_1.pickNonNull(this.tableDefinition, constants_3.PRIMARY_KEYS_PROPS);
