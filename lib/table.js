...
const stubTrue_1 = tslib_1.__importDefault(require("lodash/stubTrue"));
...
const size_1 = tslib_1.__importDefault(require("lodash/size"));
...
class Table extends events_1.EventEmitter {
    constructor(opts) {
        ...
        this.getKeyTemplate = (model, key) => {
            ...
            return flatMap_1.default(this.getKeyTemplatesForModel(model), ({ hashKey, rangeKey }) => {
        ...
        this.storeResourcesForModels = (models) => each_1.default(models, model => this.storeResourcesForModel({ model }));
        ...
        this.get = (query, opts = {}) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this._hasAllPrimaryKeys(keysObj)) {
                const keys = values_1.default(keysObj);
        ...
        this.del = (query, opts = {}) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const keys = values_1.default(this.getPrimaryKeys(query));
        ...
        this.find = (opts) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            opts = Object.assign({}, this.findOpts, cloneDeep_1.default(opts), { table: this });
        ...
        // may go away
        this.log = this._debug;
        this._initTable = () => {
            const table = dynogels_1.default.define(this.name, omit_1.default(this.tableDefinition, ['defaultReadOptions', 'primaryKeys']));
        ...
        this.deriveProps = (item, isRead = false) => {
            ...
            return omitBy_1.default(derived, (value, prop) => prop in item || value == null);
        };
        ...
        this._write = (method, resource, options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (method === 'create') {
                ...
                const { diff } = options;
                validateDiff(diff);
                options = Object.assign({}, utils.createUpdateOptionsFromDiff(diff), omit_1.default(options, ['diff']));
        ...
        this.getKeys = (resource, schema) => {
            return pick_1.default(resource, getKeyProps(schema));
        };
        ...
        // }
        this.addDerivedProperties = (resource, forRead) => extend_1.default(resource, this.deriveProps(resource, forRead));
        this.withDerivedProperties = resource => extend_1.default({}, resource, this.deriveProps(resource));
        this.omitDerivedProperties = resource => omit_1.default(resource, this.derivedProps);
        ...
        this._hasAllKeys = (obj, schema) => {
            return size_1.default(this.getKeys(obj, schema)) === size_1.default(getKeyProps(schema));
        };
        this._minify = (item) => {
        ...
        this.models = clone_1.default(models);
        ...
        this.primaryKeyProps = values_1.default(this.primaryKeys);
        this.hashKeyProps = uniq_1.default(this.indexed.map(i => i.hashKey));
        this.keyProps = uniq_1.default(flatMap_1.default(this.indexed, index => values_1.default(pick_1.default(index, constants_3.PRIMARY_KEYS_PROPS))));
        if (exclusive) {
            this.storeResourcesForModel({ model });
        }
        this._initTable();
...
const getKeyProps = (schema) => values_1.default(pickNonNull(schema, constants_3.PRIMARY_KEYS_PROPS));
