...
class Table extends events_1.EventEmitter {
    constructor(opts) {
        ...
        const { models, model, modelsStored = {}, objects, exclusive, allowScan, readOnly, defaultReadOptions, tableDefinition, deriveProps = lodash_1.default.stubObject, derivedProps = [], resolveOrderBy = utils.resolveOrderBy, getIndexesForModel = utils.getIndexesForModel, getPrimaryKeysForModel = utils.getPrimaryKeysForModel, parseDerivedProps = lodash_1.default.stubObject, shouldMinify = lodash_1.default.stubTrue } = this.opts;
        if (!models)
