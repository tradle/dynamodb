...
tape_1.default('minify (retain resource values)', function (t) {
    ...
    t.same(minThingy.min, Object.assign({}, lodash_1.default.omit(thingy, 'bigUndifferentiatedData'), { [constants_2.minifiedFlag]: ['bigUndifferentiatedData'] }));
    t.end();
});
...
tape_1.default('optimistic locking', loudAsync(async (t) => {
    ...
    t.same(await table.get(resource), Object.assign({}, resource, { _v: 1 }));
    t.end();
}));
