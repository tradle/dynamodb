...
const { debug, sortResults, wait, runWithBackoffOnTableNotExists, getTableDefinitionForModel } = require('../utils');
dynogels.log = {
    info: debug,
    warn: debug,
    level: 'info'
...
const createDB = () => {
    const db = new _1.DB({
        ...
        defineTable: name => new _1.Table(_1.DB.getSafeTableName(name), getCommonTableOpts())
    });
    return db;
};
...
test('put/update', loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    yield reload();
...
test('indexed props (_author)', loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    yield reload();
...
test('indexed props (_t)', loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    yield reload();
    yield db.batchPut(formRequests);
...
test('custom primary keys', loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    ...
    db.setExclusive({
        table: _1.createTable(Object.assign({}, getCommonTableOpts(), { model: alienModel, tableDefinition: getTableDefinitionForModel({
                models: db.models,
                model: alienModel
            }), exclusive: true }))
    });
