...
test('model store', loudAsync((t) => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
test('backoff after create', loudAsync((t) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    const backoffOpts = {
        initialDelay: 50,
        maxDelay: 100,
        maxTime: 500
    ...
    let result = yield runWithBackoffOnTableNotExists(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
        if (failsLeft-- > 0) {
    ...
    try {
        result = yield runWithBackoffOnTableNotExists(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
test('db hooks', loudAsync((t) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    const db = createDB();
    const item = {
        a: 1,
        b: 2
