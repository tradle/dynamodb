...
const dynogels_1 = tslib_1.__importDefault(require("@tradle/dynogels"));
...
const def = toDynogelTableDefinition(Object.assign(Object.assign({}, tableSchema), { TableName: 'test-resources-' + Date.now() }));
...
tape_1.default('model store', loudAsync(async (t) => {
    ...
    const onMissingModel = async (id) => {
        i++;
        store.addModels(lodash_1.default.pick(externalSource, ['tradle.Object', 'tradle.Seal', 'tradle.PubKey']));
        return externalSource[id];
    };
    const store = __1.createModelStore({
        onMissingModel
    });
...
tape_1.default('minify (big values)', function (t) {
    ...
    t.same(minBigMsg.min, {
        ...
        [constants_2.minifiedFlag]: ['message']
    });
    const smallMsg = {
        [constants_1.TYPE]: 'tradle.SimpleMessage',
...
tape_1.default('minify (retain resource values)', function (t) {
    ...
    const customModels = Object.assign(Object.assign({}, models), { [id]: {
            id,
            properties: {
                friend: {
                    type: 'object',
    ...
    t.same(minThingy.min, Object.assign(Object.assign({}, lodash_1.default.omit(thingy, 'bigUndifferentiatedData')), { [constants_2.minifiedFlag]: ['bigUndifferentiatedData'] }));
    t.end();
});
tape_1.default('minify (optional props)', function (t) {
    ...
    const customModels = Object.assign(Object.assign({}, models), { [thingy[constants_1.TYPE]]: {
            properties: {
                a: { type: 'string' },
                b: { type: 'string' }
            },
    ...
    t.same(minThingy.min[constants_2.minifiedFlag], ['b']);
    t.end();
});
...
[
    ...
    testNamed('put/update', loudAsync(async (t) => {
        ...
        const update = Object.assign(Object.assign({}, keys), { _displayName: 'blah' });
        const expected = Object.assign(Object.assign({}, photoId), update);
    ...
    testNamed('basic pagination', loudAsync(async (t) => {
        ...
        const page1Again = await db.find({
            filter,
            orderBy: Object.assign(Object.assign({}, orderBy), { desc: !orderBy.desc }),
...
tape_1.default('multiple types, overloaded indexes', loudAsync(async (t) => {
    ...
    const myModels = Object.assign(Object.assign({}, models), { [eventModel.id]: eventModel });
...
tape_1.default('specificity', t => {
    ...
    const model = {
        ...
        required: ['firstName', 'lastName'],
        indexes: indexesWithSpecificity.map(i => lodash_1.default.omit(i, 'specificity')),
    };
    const models = { [model.id]: model };
    const table1 = __1.createTable({
        objects,
        docClient,
        model,
        models,
...
tape_1.default('optimistic locking', loudAsync(async (t) => {
    ...
    t.same(await table.get(resource), Object.assign(Object.assign({}, resource), { _v: 1 }));
    t.end();
}));
...
function toProjectionTypeAll(index) {
    return Object.assign(Object.assign({}, index), { projection: {
            ProjectionType: 'ALL'
        } });
}
