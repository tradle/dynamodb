...
const { debug, wait, runWithBackoffOnTableNotExists, getTableDefinitionForModel, getQueryInfo, toDynogelTableDefinition, getTemplateStringVariables, normalizeIndexedPropertyTemplateSchema } = utils;
...
tape_1.default('multiple types, overloaded indexes', loudAsync((t) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    const gotEvent = yield table.get({
        [constants_1.TYPE]: event[constants_1.TYPE],
        payload: {
