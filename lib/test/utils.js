...
exports.getCommonTableOpts = (tableName, indexes) => {
    const def = Object.assign(Object.assign({}, tableDefinition), { tableName, indexes: indexes || tableDefinition.indexes });
    return {
        maxItemSize: 4000,
        validate: false,
        tableDefinition: def,
...
exports.createDB = ({ models, objects, docClient, indexes, tableNames }) => {
    const db = new __1.DB({
        ...
        defineTable: name => {
            ...
            const table = new __1.Table(Object.assign(Object.assign({}, opts), { models,
                objects,
                docClient }));
