...
class FilterOp {
    constructor(opts) {
        ...
        this.exec = () => __awaiter(this, void 0, void 0, function* () {
            let result;
            const { builder, models, orderBy, resultsAreInOrder, filter, after, limit, itemToPosition, queryProp, index } = this;
        ...
        this._configureBuilder = function _configureBuilder() {
            const { opType, filter, orderBy, table, queryProp, index, consistentRead, resultsAreInOrder } = this;
            const { EQ } = filter;
            const { type } = EQ;
