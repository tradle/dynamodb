...
class FilterOp {
    constructor(opts) {
        ...
        this.exec = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let result;
            const { builder, models, orderBy, defaultOrderBy, select, sortedByDB, filter, limit, checkpoint, itemToPosition, queryProp, index } = this;
            if (sortedByDB) {
        ...
        const { table, models, orderBy, limit = constants_2.defaultLimit, checkpoint, consistentRead, allowScan, bodyInObjects } = this;
        this.limit = limit;
